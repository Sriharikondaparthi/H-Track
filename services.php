	...
	<div class="container py-lg-5 py-3">
		...
		<div class="row service-grids">
			<div class="col-lg-4 col-md-6 service-grid1">
				<a href="application_form.php"><h3>A Hostel(Old Boys Hostel)</h3></a>
				<div class="row">
			...
			<div class="col-lg-4 col-md-6 mt-md-0 mt-5 service-grid1">
				<h3>B Hostel(New Boys Hostel)</h3>
				<div class="row">
					<div class="col-md-3 col-2">
						<h4>B</h4>
					</div>
			...
			<div class="col-lg-4 col-md-6 mt-5 service-grid1">
				<h3>D Hostel(Degree Boys hostel)</h3>
				<div class="row">
					<div class="col-md-3 col-2">
						<h4>D</h4>
					</div>
			...
			<div class="col-lg-4 col-md-6 mt-5 service-grid1">
				<h3>E Hostel(Degree Girls Hostel)</h3>
				<div class="row">
					<div class="col-md-3 col-2">
						<h4>E</h4>
					</div>
					...
					<div class="col-lg-3 col-sm-6 banner_bottom_right_grid">
						<div class="view view-tenth">
							<div class="agile_text_box">
								...
								<p>A Hostel(Old Boys Hostel)</p>
							</div>
							<div class="mask">
								<a href="application_form.php?id=A"><img src="web_home/images/s6.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
						<div class="view view1 view-tenth">
							<div class="agile_text_box">
								...
								<p>B Hostel(New Boys Hostel)</p>
							</div>
							<div class="mask">
								<a href="application_form.php?id=B"><img src="web_home/images/s7.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							<div class="agile_text_box">
								...
								<p>C Hostel(Girls Hostel)</p>
							</div>
							<div class="mask">
								<a href="application_form.php?id=C"><img src="web_home/images/s8.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view3 view-tenth">
							<div class="agile_text_box">
								...
								<p>D Hostel(Degree Boys Hostel) </p>
							</div>
							<div class="mask">
								<a href="application_form.php?id=D"><img src="web_home/images/s7.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
						<div class="view view1 view-tenth">
							<div class="agile_text_box">
								...
								<p>E Hostel(Degree Girls Hostel)</p>
							</div>
							<div class="mask">
								<a href="application_form.php?id=E"><img src="web_home/images/s10.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							<div class="agile_text_box">
								...
								<p>F Hostel(PG Hoostel)</p>
							</div>
							<div class="mask">
								<a href="application_form.php?id=F"><img src="web_home/images/s5.jpg" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					<!--<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
