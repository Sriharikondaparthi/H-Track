...
<body>
    <h1>Hostel Tracking Management System<br>(H-Track)</h1>
    ...
    <footer>
        <p class="copyright-agileinfo"> &copy; H-Track Project. All Rights Reserved | Design by Aravind Sir Team-06</a></p>
    </footer>
